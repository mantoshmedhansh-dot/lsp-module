...
export default function B2BLogisticsDashboard() {
  ...
  const navigation = [
    ...
    { name: "LR Management", href: "/lr", icon: FileText, current: false },
    { name: "FTL Bookings", href: "/bookings/ftl", icon: Truck, current: false },
    { name: "LTL Bookings", href: "/bookings/ltl", icon: Package, current: false },
    { name: "Consignees", href: "/consignees", icon: Users, current: false },
    { name: "POD Management", href: "/pod", icon: ClipboardCheck, current: false },
  ...
  const statCards = [
    { title: "Active LRs", value: stats.activeLRs, icon: FileText, color: "bg-blue-500" },
    { title: "In Transit", value: stats.inTransitVehicles, icon: Truck, color: "bg-amber-500" },
    { title: "Delivered Today", value: stats.deliveredToday, icon: CheckCircle, color: "bg-green-500" },
    { title: "POD Pending", value: stats.podPending, icon: ClipboardCheck, color: "bg-red-500", highlight: stats.podPending > 0 },
    { title: "Freight Dues", value: `Rs.${(stats.freightDues / 1000).toFixed(0)}K`, icon: IndianRupee, color: "bg-purple-500", isAmount: true },
    { title: "Total Consignees", value: stats.totalConsignees, icon: Users, color: "bg-indigo-500" },
  ];
    ...
    <div className="min-h-screen bg-gray-50">
      ...
      <div className={`fixed inset-0 z-50 lg:hidden ${sidebarOpen ? "" : "hidden"}`}>
        ...
        <div className="fixed inset-y-0 left-0 w-64 bg-white">
          <div className="flex h-16 items-center justify-between px-4 border-b">
            <span className="text-xl font-bold text-blue-600">CJDQuick B2B</span>
            ...
            {navigation.map((item) => (
              <a
                ...
                className={`flex items-center gap-3 px-3 py-2 rounded-lg text-sm font-medium ${
                  item.current ? "bg-blue-50 text-blue-700" : "text-gray-700 hover:bg-gray-100"
                }`}
              >
      ...
      <div className="lg:pl-64">
        ...
        <div className="sticky top-0 z-40 flex h-16 items-center gap-4 border-b bg-white px-4 sm:px-6">
          ...
          <span className="text-sm text-gray-500">B2B Logistics Portal</span>
        </div>
        ...
        <main className="p-4 sm:p-6 space-y-6">
          ...
          <div className="flex flex-col sm:flex-row sm:items-center sm:justify-between gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => router.push("/bookings/ltl")}
          ...
          <div className="grid grid-cols-1 md:grid-cols-4 gap-4">
            ...
            <button
              onClick={() => router.push("/bookings/ftl")}
                  ...
                  <div className="space-y-3">
                    {recentLRs.map((lr) => (
                      <div
                        ...
                        onClick={() => router.push(`/lr?lr=${lr.lrNumber}`)}
                      >
                        <div className="flex items-center gap-3">
          ...
          <div className="bg-gradient-to-r from-indigo-50 to-purple-50 border border-indigo-200 rounded-lg p-6">
            ...
            <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
              ...
              <div className="bg-white rounded-lg p-4 text-center">
                <p className="text-2xl font-bold text-purple-600">Rs.4.2L</p>
