...
-- FIXED: Table names use PascalCase to match existing schema
-- ============================================================================
...
CREATE INDEX IF NOT EXISTS idx_upload_batch_company ON upload_batches(company_id);
CREATE INDEX IF NOT EXISTS idx_upload_batch_type ON upload_batches(upload_type);
CREATE INDEX IF NOT EXISTS idx_upload_batch_status ON upload_batches(status);
...
CREATE INDEX IF NOT EXISTS idx_ext_po_company ON external_purchase_orders(company_id);
CREATE INDEX IF NOT EXISTS idx_ext_po_location ON external_purchase_orders(location_id);
CREATE INDEX IF NOT EXISTS idx_ext_po_status ON external_purchase_orders(status);
CREATE INDEX IF NOT EXISTS idx_ext_po_date ON external_purchase_orders(po_date);
CREATE INDEX IF NOT EXISTS idx_ext_po_expected ON external_purchase_orders(expected_delivery_date);
...
CREATE INDEX IF NOT EXISTS idx_ext_po_item_po ON external_po_items(external_po_id);
CREATE INDEX IF NOT EXISTS idx_ext_po_item_sku ON external_po_items(sku_id);
CREATE INDEX IF NOT EXISTS idx_ext_po_item_ext_sku ON external_po_items(external_sku_code);
...
CREATE TABLE IF NOT EXISTS advance_shipping_notices (
    ...
    goods_receipt_id UUID,  -- Will reference GoodsReceipt after receiving
...
CREATE INDEX IF NOT EXISTS idx_asn_company ON advance_shipping_notices(company_id);
CREATE INDEX IF NOT EXISTS idx_asn_location ON advance_shipping_notices(location_id);
CREATE INDEX IF NOT EXISTS idx_asn_status ON advance_shipping_notices(status);
CREATE INDEX IF NOT EXISTS idx_asn_expected ON advance_shipping_notices(expected_arrival);
CREATE INDEX IF NOT EXISTS idx_asn_ext_po ON advance_shipping_notices(external_po_id);
CREATE INDEX IF NOT EXISTS idx_asn_po ON advance_shipping_notices(purchase_order_id);
...
CREATE INDEX IF NOT EXISTS idx_asn_item_asn ON asn_items(asn_id);
CREATE INDEX IF NOT EXISTS idx_asn_item_sku ON asn_items(sku_id);

-- ============================================================================
-- 6. ENHANCE GOODS RECEIPT TABLE
-- ============================================================================
...
ALTER TABLE "GoodsReceipt"
ADD COLUMN IF NOT EXISTS return_id UUID REFERENCES "Return"(id);
...
CREATE INDEX IF NOT EXISTS idx_gr_inbound_source ON "GoodsReceipt"(inbound_source);
CREATE INDEX IF NOT EXISTS idx_gr_external_po ON "GoodsReceipt"(external_po_id);
CREATE INDEX IF NOT EXISTS idx_gr_asn ON "GoodsReceipt"(asn_id);
CREATE INDEX IF NOT EXISTS idx_gr_return ON "GoodsReceipt"(return_id);
CREATE INDEX IF NOT EXISTS idx_gr_external_ref ON "GoodsReceipt"(external_reference_no);
...
LEFT JOIN "Location" l ON epo.location_id = l.id
LEFT JOIN "Vendor" v ON epo.vendor_id = v.id
